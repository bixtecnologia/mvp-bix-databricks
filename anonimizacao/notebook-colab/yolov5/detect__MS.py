...
def run(
    ...
    # src_dir = '/dbfs/mnt/tempdataservice/landing-zone/inputs'
    ...
    print("arquivos processados:", seen)
    print("arquivos presentes na pasta original: ", total_files)
    print("relação arquivos processados / presentes na pasta: ", seen / total_files)
	# time 
    end_time = time.time()
...
def parse_opt():
    ...
    parser.add_argument('--pos_anonimizar', type=str, default=ROOT / 'runs/detect/pos_anonimizar', help='destination path for orginial photos')
